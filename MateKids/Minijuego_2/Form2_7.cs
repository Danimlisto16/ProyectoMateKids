...
{
    public partial class Form2_7 : MetroFramework.Forms.MetroForm
    {
        ...
        public Form2_7(int[] numeros, int intento, int nventana, int puntaje)
        {
            InitializeComponent();
