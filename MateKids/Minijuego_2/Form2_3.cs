...
{
    public partial class Form2_3 : MetroFramework.Forms.MetroForm
    {
        ...
        public Form2_3(int[] numeros, int intento, int nventana, int puntaje)
        {
            InitializeComponent();
