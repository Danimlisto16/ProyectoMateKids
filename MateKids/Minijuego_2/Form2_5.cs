...
{
    public partial class Form2_5 : MetroFramework.Forms.MetroForm
    {
        ...
        public Form2_5(int[] numeros, int intento, int nventana, int puntaje)
        {
            InitializeComponent();
