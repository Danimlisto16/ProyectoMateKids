...
{
    public partial class Form2_10 : MetroFramework.Forms.MetroForm
    {
        ...
        public Form2_10(int[] numeros, int intento, int nventana, int puntaje)
        {
            InitializeComponent();
