...
{
    public partial class Form2_8 : MetroFramework.Forms.MetroForm
    {
        ...
        public Form2_8(int[] numeros, int intento, int nventana, int puntaje)
        {
            InitializeComponent();
