...
{
    public partial class Form2_2 : MetroFramework.Forms.MetroForm
    {
        ...
        public Form2_2(int[] numeros, int intento, int nventana, int puntaje)
        {
            InitializeComponent();
