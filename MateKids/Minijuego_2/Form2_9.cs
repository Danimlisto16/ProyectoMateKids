...
{
    public partial class Form2_9 : MetroFramework.Forms.MetroForm
    {
        ...
        public Form2_9(int[] numeros, int intento, int nventana, int puntaje)
        {
            InitializeComponent();
        ...
        private void Form2_9_Load(object sender, EventArgs e)
        {
            lblintentos.Text = "" + intento;
            lblpuntaje.Text = "" + puntaje;
        }
