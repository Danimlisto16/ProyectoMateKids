...
namespace MateKids.Miinijuego_7
{
    public partial class Form10 : Form
    {
        ...
        public Form10(int[] numeros, int intento, int nventana, int puntaje)
        {
            InitializeComponent();
        ...
        {
            int casilleros = 0;
            if ((mtb_div0.Text != "") && (mtb_div1.Text != "") && (mtb_div2.Text != "") && (mtb_div3.Text != "") && (mtb_div4.Text != "") && (mtb_div5.Text != "") && (mtb_div6.Text != "") && (mtb_div7.Text != "") && (mtb_div8.Text != "") && (mtb_div9.Text != "") && (mtb_res1.Text != "") && (mtb_res2.Text != ""))
            {
                ...
                if (mtb_div0.Text == "3")
                {
                    mtb_div0.Enabled = false;
                    //puntaje++;
                    casilleros++;
                }
                else
                {
                    mtb_div0.ForeColor = Color.Red;
                    error++;
                }
